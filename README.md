...
**Project**: friend-o-matic 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a website that displays users like friends list from facebook, you should get a list of mock users from any open source api that generates fake users 
...
```sh
git clone https://github.com/GPT-Engineer-App/friend-o-matic.git
cd friend-o-matic
npm i
